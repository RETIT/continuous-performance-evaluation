...
public class HandlingEventFactory implements Serializable {
    ...
    public HandlingEvent createHandlingEvent(Date registrationTime,
        ...
        if(type.requiresVoyage())
        	voyage = findVoyage(voyageNumber);
        
//        if(voyageNumber!=null && voyageNumber.getIdString()!=null && voyageNumber.getIdString().equals("TESTV")){
//        	voyage = new Voyage(new VoyageNumber("TESTV"),new Schedule());
